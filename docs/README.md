...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-22 20:54:25 UTC<br>状态：成功</p>
</section>
...
<p>今日速读4篇论文，聚焦LLM智能体在路径规划与自主导航中的应用。</p>
<p>最值得关注的是基于无人机场景的LLM路径规划（LAPF）及面向海上风电场的世界模型导航规划，均获7分。</p>
<p>下一步可优先精读这两篇，探索场景数据与世界模型如何提升LLM智能体的现实导航能力。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="LAPF: LLM-Agent-Based Path Finder Using the UAVScenes Dataset">LAPF: LLM-Agent-Based Path Finder Using the UAVScenes Dataset</span></li><li><span class="dpr-home-dashboard-paper-title" title="World-Model-Grounded LLM Planning for AUV and ASV Navigation Near Offshore Wind Farms">World-Model-Grounded LLM Planning for AUV and ASV Navigation Near Offshore Wind Farms</span></li><li><span class="dpr-home-dashboard-paper-title" title="HaReCAP: Habitual-action Grounding for Recursive Large Language Model Agents">HaReCAP: Habitual-action Grounding for Recursive Large Language Model Agents</span></li></ul>
  </div>
